...
When the app is running it is currently on http://localhost:8080
. HTML files are being stored in src/main/resources/static/. To access the frontend you can go to http://localhost:8080/index.html
, http://localhost:8080/student_Login.html
, http://localhost:8080/teacher-Login.html
, etc.
